...
float thrust_neutral = 1000;
float thrust_amplitude = 500;
float thrust_min = 0;
float thrust_max = 2000;
float pitch_amplitude = 20;
float pitch_desired = 0;
float roll_amplitude = 20;
...
int main (int argc, char *argv[])
{
    ...
    while(run_program == 1)
    {
      ...
      if (flag_print) {
        ...
        printf("%f, %f, %d, %d, %d, %d \n", yaw_desired, imu_data[3], motor_commands[3], motor_commands[2],motor_commands[1],motor_commands[0]);
